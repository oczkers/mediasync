...
__copyright__ = 'Copyright 2018 Piotr Staroszczyk'
...
setup(
    name=__title__,
    version=__version__,
    description='%s is a simple script for syncing account data beetwen various music/video providers.' % __title__,
    ...
    platforms='any',
    keywords='%s sync playlist favorites deezer hbo netflix' % __title__,
    packages=packages,
